"""Shared helpers for the GetAJob CLI package.

Extracted from the monolithic ``cli.py`` during an architecture
deepening — these functions are used by multiple command modules.
"""
...
# ── Rich console (shared across all CLI commands) ──────────────────────────────
